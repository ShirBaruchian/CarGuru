...
@Composable
fun ProfileScreen(navController: NavHostController, profile: User, userViewModel: UserViewModel, onLogout: () -> Unit) {
    ...
    Column(
        ...
        if (isEditMode) {
            ...
            Text(text = "Username", fontSize = 14.sp, modifier = Modifier.align(Alignment.Start))
